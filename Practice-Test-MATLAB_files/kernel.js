...
if(l){var q=true;
if(o){var p=parseFloat(o.latitude);
var n=parseFloat(o.longitude);
...
f();
if(h){h.getCurrentPosition(function(e){var l={longitude:e.coords.longitude,latitude:e.coords.latitude};
...
if(!CQ_Analytics.AkamaiProfileMgr){CQ_Analytics.AkamaiProfileMgr=new CQ_Analytics.SessionStore();
CQ_Analytics.AkamaiProfileMgr.STOREKEY="AKAMAIPROFILE";
CQ_Analytics.AkamaiProfileMgr.STORENAME="akamaiprofile";
CQ_Analytics.AkamaiProfileMgr.data={};
CQ_Analytics.AkamaiProfileMgr.addInitProperty("countryCode","");
CQ_Analytics.ClientContextMgr.register(CQ_Analytics.AkamaiProfileMgr)
}if(!CQ_Analytics.EloquaProfileMgr){CQ_Analytics.EloquaProfileMgr=function(){};
CQ_Analytics.EloquaProfileMgr.prototype=new CQ_Analytics.PersistedSessionStore();
CQ_Analytics.EloquaProfileMgr.prototype.STOREKEY="ELOQUAPROFILE";
CQ_Analytics.EloquaProfileMgr.prototype.STORENAME="eloquaprofile";
CQ_Analytics.EloquaProfileMgr.prototype.init=function(){this.persistence=new CQ_Analytics.SessionPersistence({container:"ClientContext"});
var a=this.persistence.get(this.getStoreKey());
if(!a||a===""){this.data={};
for(var b in this.initProperty){this.data[b]=this.initProperty[b]
}}else{this.data=this.parse(a)
...
CQ_Analytics.EloquaProfileMgr=new CQ_Analytics.EloquaProfileMgr();
CQ_Analytics.EloquaProfileMgr.addInitProperty("potentialUse","");
CQ_Analytics.EloquaProfileMgr.addInitProperty("jobRole","");
CQ_Analytics.EloquaProfileMgr.addInitProperty("countryCode","");
CQ_Analytics.EloquaProfileMgr.addInitProperty("stateCode","");
CQ_Analytics.ClientContextMgr.register(CQ_Analytics.EloquaProfileMgr)
};